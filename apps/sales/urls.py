...
from .views import CommandeViewSet, LivraisonViewSet, NotificationViewSet, BottleReturnViewSet, SubscriptionViewSet, FAQViewSet, AgentRatingViewSet, ProductViewSet
